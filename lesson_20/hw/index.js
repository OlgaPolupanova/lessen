...
// 3) написать функцию которая принмает два числа и выводит в консоль их расность
// 4) написать функцию которая объект и возвращает этот объект с новым свойстом "age" равным числу
...
// 7) написать функцию которая принимает два числа и возвращает ментшее из них
// 8) написать функцию которая принимает два числа и true если эти два числа равны
